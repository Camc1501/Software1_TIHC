 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":customer-address",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "customer-address",
                           xmlWriter);
                                    ...
                                    writeStartElement(null, namespace, "customer-number", xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://ws.wso2.org/dataservice/samples/rdbms_sample";
                                    writeStartElement(null, namespace, "address-line1", xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://ws.wso2.org/dataservice/samples/rdbms_sample";
                                    writeStartElement(null, namespace, "address-line2", xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://ws.wso2.org/dataservice/samples/rdbms_sample";
                                    writeStartElement(null, namespace, "postal-code", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static CustomerAddress parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"customer-address".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CustomerAddress)org.wso2.ws.dataservice.samples.rdbms_sample.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.wso2.org/dataservice/samples/rdbms_sample","customer-number").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.wso2.org/dataservice/samples/rdbms_sample","address-line1").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.wso2.org/dataservice/samples/rdbms_sample","address-line2").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.wso2.org/dataservice/samples/rdbms_sample","state").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.wso2.org/dataservice/samples/rdbms_sample","postal-code").equals(reader.getName())){
