 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":customerAddress",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "customerAddress",
    ...
    public static class Factory{
        ...
        */
        public static CustomerAddressE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CustomerAddressE object =
                new CustomerAddressE();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"customerAddress".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CustomerAddressE)org.wso2.ws.dataservice.samples.rdbms_sample.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
