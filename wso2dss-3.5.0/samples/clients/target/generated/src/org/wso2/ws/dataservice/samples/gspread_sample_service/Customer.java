                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                            ...
                                            if (localCustomerName != null){
                                                ...
                                                writeAttribute("",
                                                         "customerName",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCustomerName), xmlWriter);
                                    ...
                                    namespace = "http://ws.wso2.org/dataservice/samples/gspread_sample_service";
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            attribList.add(
                            new javax.xml.namespace.QName("","customerName"));
                            
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localCustomerName));
        ...
        public static Customer parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Customer".equals(type)){
                                ...
                                return (Customer)org.wso2.ws.dataservice.samples.gspread_sample_service.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    // handle attribute "customerName"
                    java.lang.String tempAttribCustomerName =
                        
                                reader.getAttributeValue(null,"customerName");
                            
                   if (tempAttribCustomerName!=null){
                         java.lang.String content = tempAttribCustomerName;
                        
                                                 object.setCustomerName(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(tempAttribCustomerName));
                                            
                    } else {
                       
                    }
                    handledAttributes.add("customerName");
                   ...
                   if (tempAttribCity!=null){
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ws.wso2.org/dataservice/samples/gspread_sample_service","customerNumber").equals(reader.getName())){
