 ...
 */
            ...
            /**
            *  EmployeesByNumber bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EmployeesByNumber
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":employeesByNumber",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "employeesByNumber",
    ...
    public static class Factory{
        ...
        */
        public static EmployeesByNumber parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EmployeesByNumber object =
                new EmployeesByNumber();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"employeesByNumber".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EmployeesByNumber)org.wso2.ws.dataservice.samples.rdbms_sample.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
